...
class DatabaseHandler:
    ...
    def insert_file_record(self, file,filename,orig_size,new_size):
        """Insert a new compressed file record into the database."""
        self.cursor.execute("INSERT INTO PyBak_Details (FNAME, COMPRESSED_FNAME, ORIG_SIZE, COMPRESSED_SIZE) VALUES (?,?,?,?)", (file,filename,orig_size,new_size,))
        self.conn.commit()
